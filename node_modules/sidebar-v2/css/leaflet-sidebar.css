.sidebar {
  ...
  top: 0;
  bottom: 0;
  width: 310px; /* This is how wide the sidebar is when open */
  overflow: hidden; /* Not sure what this does */ 
  z-index: 2000; }
  .sidebar.collapsed {
    width: 40px; } /* This is how wide the sidebar is when collapsed. Hides under tabs. */ 
  .sidebar.wider { 
  	width: 320px; }
  @media (min-width: 0px) {
    .sidebar {
      top: 6px; /* The thin margins at the top and bottom of the sidebar */
      bottom: 6px;
      transition: width 200ms; } }/* How long the sidebar takes to open? Maybe? */
  /* This stuff changes the width of the sidebar with different window sizes.
     The behavior was strange and resulted in unexpected changes in the 
     GUI layout.
  ...
  */
  ...
  /* Might be able to so something here to make the width larger for certain tabs */
...
/* This sets the width of the panes inside the sidebar so stuff doesn't overflow
 and get hidden. Sortof.*/
.sidebar-pane { 
  display: none;
  left: 0;
  right: 0;
